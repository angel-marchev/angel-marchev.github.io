...
void gadove_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[3])
{
  real_T (*best)[3];
  emxArray_real_T *rec;
  ...
  best = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  ...
  gadove(x, y, z, rec, *best, &iter);

  /* Marshall function outputs */
  rec->canFreeData = false;
  plhs[0] = emlrt_marshallOut(rec);
  emxFree_real_T(&rec);
  if (nlhs > 1) {
    plhs[1] = b_emlrt_marshallOut(*best);
  }

  if (nlhs > 2) {
    plhs[2] = c_emlrt_marshallOut(iter);
  }

  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

void gadove_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  gadove_xil_terminate();
}

void gadove_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_gadove_api.c) */
